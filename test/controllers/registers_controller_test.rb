...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { grade: @register.grade, name: @register.name, roll: @register.roll, std: @register.std } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { grade: @register.grade, name: @register.name, roll: @register.roll, std: @register.std } }
